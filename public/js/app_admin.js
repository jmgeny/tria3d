...
var api_search_autocomplete = new Vue({
  ...
  // se va a recargar el id formulario
  data: {
    palabra_a_buscar: '',
    resultados: []
  },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.palabra_a_buscar = resultado.name;
                _context.next = 3;
    ...
    getCategory: function getCategory() {
      ...
      if (this.slug) {
        ...
        axios.get(url).then(function (response) {
          _this.div_mensage_slug = response.data;

          if (_this.div_mensage_slug === "Slug Disponible") {
          ...
          if (document.getElementById('editar')) {
            if (_this.name === document.getElementById('nombretemp').innerHTML) {
              _this.div_clase_slug = 'badge badge-success';
              _this.deshabilitar_boton = 0;
              _this.div_mensage_slug = 'Conserva el nombre de la Categoria';
              _this.div_aparecer = true;
            }
          } //if (document.getElementById('editar'))
...
var apiproduct = new Vue({
  ...
  methods: {
    eliminarImagen: function eliminarImagen(image) {
      // SweetAlert
      swal({
        title: "Esta seguro?",
    ...
    getproduct: function getproduct() {
      ...
      if (this.slug) {
        ...
        axios.get(url).then(function (response) {
          ...
          if (data.datos.name === _this.name) {
            _this.deshabilitar_boton = 0;
            _this.div_mensage_slug = 'Conserva el nombre del producto';
            _this.div_aparecer = true;
            _this.div_clase_slug = 'badge badge-success';
          }
        });
...
var confirmareliminar = new Vue({
  ...
  methods: {
    desea_eliminar: function desea_eliminar(id) {
...
if (document.getElementById('confirmareliminar')) {
  __webpack_require__(/*! ./admin/confirmareliminar */ "./resources/js/admin/confirmareliminar.js");
}
...
module.exports = __webpack_require__(/*! C:\Users\jmgeny\Documents\laravel7\CursoTienda\bragadoshop7\resources\js\app_admin.js */"./resources/js/app_admin.js");
